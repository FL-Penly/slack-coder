...
class ChannelRouting:
    ...
    claude_mode: Optional[str] = None  # "plan" | None (normal mode)
    claude_model: Optional[str] = None  # "claude-sonnet-4-20250514" | etc
    claude_env_vars: Optional[Dict[str, str]] = None  # Vertex AI env vars
    ...
    def from_dict(cls, data: dict) -> "ChannelRouting":
        ...
        return cls(
            ...
            claude_mode=data.get("claude_mode"),
            claude_model=data.get("claude_model"),
            claude_env_vars=data.get("claude_env_vars"),
        )
